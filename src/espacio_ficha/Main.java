...
public static void main(String[] args) {
        ...
        c_1[1].setFicha(f1);
        c_1[1].getCantidad().add(f1[0]);
        c_1[1].getCantidad().add(f1[1]);
        f1[0].setCasilla(c_1[1]);
